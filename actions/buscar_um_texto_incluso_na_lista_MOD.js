module.exports = {
	...
	name: "Buscar um texto incluso na lista",
	...
	subtitle: function(data) {
		...
		return `Procurar texto incluso "${data.item}" em ${list[parseInt(data.list)]}`;
	},
	...
	<div style="padding-top: 8px;">
		...
		<textarea id="item" rows="4" class="round" placeholder="Insira uma variável ou algum texto. Esses '' não são necessários!" style="width: 94%; font-family: monospace;"></textarea>
	</div><br>
	<div style="padding-top: 8px;">
