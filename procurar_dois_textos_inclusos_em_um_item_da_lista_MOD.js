...
subtitle: function(data) {
	...
	return `Find text included "${data.item}" & "${data.item2}" in ${list[parseInt(data.list)]}`;
},
...
<div style="padding-top: 8px;">
	...
	<textarea id="item" rows="1" placeholder="Insira uma variável ou algum texto. Esses '' não são necessários!" style="width: 94%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>&&<br>
	<textarea id="item2" rows="1" placeholder="Insira uma variável ou algum texto. Esses '' não são necessários!" style="width: 94%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		Store In:<br>
